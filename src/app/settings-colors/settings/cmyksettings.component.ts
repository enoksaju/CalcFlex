    ...
    <ng-container *ngIf="active">
      ...
      <ng-template #tL>
        <ion-item>
          ...
          <ion-input [(ngModel)]="converters.cmyk.C" min="0" step="0.01" max="1" type="number" (ionChange)="change()"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label color="magent" position="fixed" text-right>Magenta</ion-label>
          <ion-input [(ngModel)]="converters.cmyk.M" min="0" step="0.01" max="1" type="number" (ionChange)="change()"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label color="yellow" position="fixed" text-right>Amarillo</ion-label>
          <ion-input [(ngModel)]="converters.cmyk.Y" min="0" step="0.01" max="1" type="number" (ionChange)="change()"></ion-input>
        </ion-item>
        <ion-item>
          <ion-label color="dark" position="fixed" text-right>Negro</ion-label>
          <ion-input [(ngModel)]="converters.cmyk.K" min="0" step="0.01" max="1" type="number" (ionChange)="change()"></ion-input>
        </ion-item>
      </ng-template>
    </ng-container>
  `,
