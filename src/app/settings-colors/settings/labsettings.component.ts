      ...
      <ng-container *ngIf="!numeric; else: tL">
        <ion-item>
          <ng-container>
            ...
            <div slot="end" style="width: 60px; margin: 0px;" (click)="converters.lab.L = 50">
              {{ (converters.lab.L ? converters.lab.L : 0) | number: '1.2-2' }}
            </div>
          </ng-container>
        </ion-item>
        ...
        <ion-item>
          ...
          <div slot="end" style="width: 60px; margin: 0px;" (click)="converters.lab.A = 0">
            {{ (converters.lab.A ? converters.lab.A : 0) | number: '1.2-2' }}
          </div>
        </ion-item>
        <ion-item>
          ...
          <div slot="end" style="width: 60px; margin: 0px;" (click)="converters.lab.B = 0">
            {{ (converters.lab.B ? converters.lab.B : 0) | number: '1.2-2' }}
          </div>
        </ion-item>
      </ng-container>
      <ng-template #tL>
        <ion-grid>
          <ion-row>
            <ion-col>
              <ion-item>
                <ion-label text-right>L:</ion-label>
                <ion-input
                  [(ngModel)]="converters.lab.L"
                  min="0"
                  max="100"
                  type="number"
                  (ionChange)="change()"
            ...
            <ion-col>
              <ion-item>
                <ion-label text-right>A:</ion-label>
                <ion-input
                  [(ngModel)]="converters.lab.A"
                  min="-100"
                  max="100"
                  type="number"
                  (ionChange)="change()"
            ...
            <ion-col>
              <ion-item>
                <ion-label text-right>B:</ion-label>
                <ion-input
                  [(ngModel)]="converters.lab.B"
                  min="-100"
                  max="100"
                  type="number"
                  (ionChange)="change()"
